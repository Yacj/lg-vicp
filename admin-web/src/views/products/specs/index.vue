...
import type { ProductSpec, ProductSpecInput, ProductSpecQuery } from '@/types/masterdata'
...
const columns: PrimaryTableCol<TableRowData>[] = [
  { cell: (_, { row }) => h('div', [
    ...
    h('div', { class: 'vicp-spec-series' }, seriesName(row.seriesId)),
...
<template>
  <AppPage title="产品规格" description="产品规格明细（厚度/燃烧等级/供应状态）；同系列同规格编码仅一个已发布版本。">
    <template #search>
