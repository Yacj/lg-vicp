...
import type { ConstructionScheme, ConstructionSchemeInput, ConstructionSchemeQuery } from '@/types/construction'
import type { ValidationResult } from '@/types/construction'
...
<template>
  <AppPage title="构造方案" description="构造方案（基层 + 构造层 + 产品选项）是候选匹配的核心；提交审核与发布前会强制执行结构校验。">
    <template #search>
