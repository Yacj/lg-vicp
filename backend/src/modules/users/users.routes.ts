...
export async function userRoutes(app: FastifyInstance) {
  ...
  route.get("/users", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "获取用户列表", querystring: listQuerySchema } }, async (request) => {
  ...
  route.get("/users/export", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "导出用户 CSV", querystring: listQuerySchema } }, async (request, reply) => {
  ...
  route.post("/users/import", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "导入用户 CSV", body: importBodySchema } }, async (request) => {
  ...
  route.post("/users", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "创建用户", body: createUserBodySchema } }, async (request) => {
  ...
  route.get("/users/:id", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "获取用户详情", params: userParamsSchema } }, async (request) => {
    await requireUserPermission(request, "system:user:list");
  ...
  route.patch("/users/:id", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "修改用户资料", params: userParamsSchema, body: updateUserBodySchema } }, async (request) => {
  ...
  route.patch("/users/:id/status", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "修改用户状态", params: userParamsSchema, body: updateStatusBodySchema } }, async (request) => {
    const actor = await requireUserPermission(request, "system:user:edit");
  ...
  route.delete("/users/:id", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "删除用户", params: userParamsSchema } }, async (request) => {
  ...
  route.post("/users/:id/restore", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "恢复用户", params: userParamsSchema } }, async (request) => {
    const actor = await requireUserPermission(request, "system:user:edit");
  ...
  route.post("/users/:id/reset-password", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "重置用户密码", params: userParamsSchema, body: resetPasswordSchema } }, async (request) => {
  ...
  route.put("/users/:id/posts", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "分配用户岗位", params: userParamsSchema, body: idsBodySchema } }, async (request) => {
  ...
  route.put("/users/:id/departments", { preHandler: [app.authenticate], schema: { tags: ["用户管理"], summary: "分配用户部门", params: userParamsSchema, body: idsBodySchema } }, async (request) => {
