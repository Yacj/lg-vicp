...
export const AUDIT_ACTIONS = {
  ...
  AI_MEMORY_CONFIRMED: "ai.memory_confirmed",
  AI_MEMORY_REJECTED: "ai.memory_rejected",
  AI_MEMORY_UPDATED: "ai.memory_updated",
  AI_AGENT_RUN_COMPLETED: "ai.agent_run_completed",
  ...
  COLLECTION_SOURCE_CREATED: "collection.source_created",
  COLLECTION_SOURCE_UPDATED: "collection.source_updated",
