...
const swaggerTags = [
  ...
  { name: "B端 / 平台 / 采集管理", description: "B 端独立采集管理（手动/自动获取外部候选资料，确认后导入知识库）" },
  ...
  { name: "B端 / 平台 / 主数据", description: "Legacy：产品系列/规格/参数、材料参数接口保留兼容；普通菜单已隐藏，新资料进入知识库" },
  { name: "B端 / 平台 / 企业信息", description: "B 端普通企业信息与资质（名称/简称/Logo/简介/官网/资质附件）" },
  ...
  { name: "C端 / 企业内容", description: "C 端企业介绍只读接口（关于我们：名称/Logo/简介/官网/资质）" },
